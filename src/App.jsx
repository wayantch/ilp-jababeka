  ...
  const REVIEWS = [
    ...
    return (
        <>
            ...
            <div className="w-full h-auto md:h-[677px] flex flex-col justify-center items-center relative overflow-hidden py-10 md:py-0">
                ...
                <div className="h-auto md:h-[557px] flex flex-col justify-start items-center gap-6 md:gap-10 px-4 md:px-0">
                    ...
                    <div className="w-full md:w-[470px] text-center text-[#838383] text-sm md:text-base font-normal font-['Roboto'] tracking-tight">
                        "Program kursus terbaik dengan pendekatan praktis &
                        interaktif. <br />
                        Kuasai bahasa Inggris & Jepang dengan efektif di
                        Cikarang."
                    </div>
                    <div className="flex flex-col justify-start items-center mt-6 md:mt-10">
                        <div className="w-full md:w-auto shadow-[0px_2px_12px_0px_rgba(0,0,0,0.14)] flex flex-col md:flex-row justify-center items-center">
                            <div className="w-full md:w-[300px] px-4 py-3 md:pl-6 md:pr-[140px] md:py-5 bg-white rounded-t-lg md:rounded-tl-lg md:rounded-bl-lg md:rounded-tr-none border border-[#aaaaaa]/40">
                                <input
                                    type="email"
                                    placeholder="Masukkan email anda disini!"
                                    className="w-full text-center md:text-left text-[#aaaaaa] text-sm md:text-base font-normal font-['Roboto'] tracking-tight focus:outline-none"
                                />
                            </div>
                            <button className="w-full md:w-auto px-6 py-3 md:py-5 bg-[#2c4cac] rounded-b-lg md:rounded-tr-lg md:rounded-br-lg md:rounded-tl-none text-[#ecf0f8] text-sm md:text-base font-normal font-['Roboto'] tracking-tight">
                                Daftar Sekarang
                            </button>
                        </div>
            ...
            {/* Choose Section */}
            <div className="container w-full h-auto md:h-[266px] py-10 md:pt-[60px]  flex justify-center items-center">
                <div className="w-full md:w-[676px] flex flex-col justify-start items-center gap-6">
                    ...
                    <p className="text-[#838383] text-sm md:text-base font-normal font-['Roboto'] text-center">
                        Kami adalah International Language Professional (ILP)
                        yang berkomitmen untuk memberikan kursus bahasa Inggris
                        dan Jepang berkualitas yang telah dirancang sedemikian
                        rupa mencapai tujuan pemahaman anda dan sebagai tempat
                        pembelajaran bahasa anda, kami menyediakan lingkungan
                        belajar teraktif, tenaga pengajar berpengalaman dan
                        bersertifikat.
                    </p>
                </div>
            </div>
            ...
            {/* Branding Section */}
            <div className=" px-6 lg:px-20 w-full h-auto md:h-[760px] py-10 md:py-[60px] flex flex-col md:flex-row justify-center items-center gap-10 md:gap-10">
                <div className="w-full md:w-[650px] flex flex-col justify-start items-start gap-6 ">
                    <div className="flex flex-col justify-start items-start gap-5">
                        ...
                        <p className="text-[#838383] text-sm md:text-base font-normal font-['Roboto']">
                            "Berkembangnya industri bisnis digital dalam
                            beberapa tahun terakhir telah menciptakan peluang
                            kerja baru di berbagai bidang yang terkait dengan
                            transformasi digital. Dengan menguasai bahasa
                            Inggris dan Jepang melalui kursus di International
                            Language Professional (ILP), Anda dapat meningkatkan
                            peluang karir di berbagai sektor, mulai dari digital
                            marketing, pengembangan startup, analisis data
                            bisnis, hingga profesional di perusahaan berbasis
                            teknologi global. Bergabunglah dengan ILP Cikarang
                            untuk mempersiapkan diri menghadapi tantangan dan
                            peluang di era digital dengan keterampilan bahasa
                            yang unggul."
                        </p>
                    </div>
                    ...
                    <div className="flex gap-5">
                        <button className="w-full md:w-auto px-6 py-3 md:px-8 md:py-4 bg-[#2c4cac] rounded-lg text-[#ecf0f8] text-sm md:text-lg font-bold font-['Roboto']">
                            Daftarkan dirimu sekarang
                        </button>
                        <button className="w-full md:w-auto px-6 py-3 md:px-8 md:py-4 bg-[#849fe4] rounded-lg flex items-center gap-2 text-[#ecf0f8] text-sm md:text-lg font-bold font-['Roboto']">
                            <img
            ...
            <div className="container w-full h-auto lg:h-[564px] py-10 lg:py-[60px] flex justify-center items-center">
                <div className="w-full max-w-[1440px] flex flex-col justify-start items-start gap-5">
                    ...
                    <div className="w-full lg:w-[676px] text-black text-2xl lg:text-[34px] font-bold font-['Merriweather'] tracking-tight">
                        Keunggulan belajar di Kursus Bahasa Inggris dan Bahasa
                        Jepang di Cikarang By International Language
                        Professional
                    </div>
                    ...
                    <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div className="p-3 bg-white rounded-lg shadow-[0px_4px_8px_0px_rgba(0,0,0,0.12)] flex flex-col md:flex-row lg:flex-col justify-start items-start gap-3">
                            ...
                            <div className="flex flex-col justify-start items-start gap-1">
                                <div className="text-black text-base font-bold font-['Merriweather']">
                                    Maksimalkan Potensimu dengan Pembelajaran
                                    Terarah
                                </div>
                                <div className="text-[#838383] text-sm font-light font-['Roboto'] tracking-tight">
                                    "Raih keahlian bahasa dengan metode
                                    pembelajaran interaktif yang telah terbukti
                                    efektif. Belajar bersama tutor profesional
                                    untuk hasil terbaik!"
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-3 bg-white rounded-lg shadow-[0px_4px_8px_0px_rgba(0,0,0,0.12)] flex flex-col md:flex-row lg:flex-col justify-start items-start gap-3">
                            ...
                            <div className="flex flex-col justify-start items-start gap-1">
                                <div className="text-black text-base font-bold font-['Merriweather']">
                                    Belajar Langsung Dari Pengajar di Tingkat
                                    Mahir
                                </div>
                                <div className="text-[#838383] text-sm font-light font-['Roboto'] tracking-tight">
                                    “Mendapatkan pengalaman dan pembelajaran
                                    dari ahli yang sudah pernah tinggal di
                                    eropa, dengan mengenal budaya disana
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-3 bg-white rounded-lg shadow-[0px_4px_8px_0px_rgba(0,0,0,0.12)] flex flex-col md:flex-row lg:flex-col justify-start items-start gap-3">
                            ...
                            <div className="flex flex-col justify-start items-start gap-1">
                                ...
                                <div className="text-[#838383] text-sm font-light font-['Roboto'] tracking-tight">
                                    "Wujudkan impian berkarier di dunia global
                                    dengan menguasai bahasa asing. Daftar
                                    sekarang dan ambil langkah pertama menuju
                                    kesuksesan!"
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-3 bg-white rounded-lg shadow-[0px_4px_8px_0px_rgba(0,0,0,0.12)] flex flex-col md:flex-row lg:flex-col justify-start items-start gap-3">
                            ...
                            <div className="flex flex-col justify-start items-start gap-1">
                                ...
                                <div className="text-[#838383] text-sm font-light font-['Roboto'] tracking-tight">
                                    "Belajar kapan saja dan di mana saja dengan
                                    materi berkualitas tinggi yang dirancang
                                    untuk semua level pembelajaran!"
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-3 bg-white rounded-lg shadow-[0px_4px_8px_0px_rgba(0,0,0,0.12)] flex flex-col md:flex-row lg:flex-col justify-start items-start gap-3">
                            ...
                            <div className="flex flex-col justify-start items-start gap-1">
                                ...
                                <div className="text-[#838383] text-sm font-light font-['Roboto'] tracking-tight">
                                    "Belajar sesuai dengan kebutuhan! Pilih
                                    kelas online yang praktis atau kelas offline
                                    dengan interaksi langsung untuk pengalaman
                        ...
                        <div className="p-3 bg-white rounded-lg shadow-[0px_4px_8px_0px_rgba(0,0,0,0.12)] flex flex-col md:flex-row lg:flex-col justify-start items-start gap-3">
                            ...
                            <div className="flex flex-col justify-start items-start gap-1">
                                ...
                                <div className="text-[#838383] text-sm font-light font-['Roboto'] tracking-tight">
                                    "Buktikan kemampuan bahasamu dengan
                                    sertifikat profesional yang dapat
                                    meningkatkan peluang kerja dan pendidikan
                                    lebih lanjut!"
                                </div>
                            </div>
                        </div>
            ...
            {/* Biaya Section */}
            <div className="w-full h-auto lg:h-[899px] px-4 lg:px-[34px] pt-10 lg:pt-[60px] pb-10 flex justify-center items-center">
                <div className="w-full max-w-[1440px] flex flex-col justify-start items-center gap-6 lg:gap-10">
                    ...
                    <div className="w-full lg:w-[674px] text-center">
                        <h1 className="text-black text-2xl lg:text-[34px] font-bold font-['Merriweather'] tracking-tight">
                            Biaya Kursus yang Terjangkau di Jababeka Cikarang &
                            Sekitarnya
                        </h1>
                        <p className="mt-4 text-[#838383] text-sm lg:text-base font-normal font-['Roboto'] tracking-tight">
                            Harga yang anda keluarkan untuk belajar di kami ini
                            lebih murah dibanding dengan kursus yang lain, raih
                            lah masa depan anda bersama kami!
                        </p>
                    </div>
                    ...
                    <div className="w-full flex flex-col lg:flex-row justify-between items-center lg:items-end gap-6 lg:gap-0">
                        ...
                        <div className="w-full lg:w-[314px] h-auto bg-[#2c4cac] rounded-xl p-6 lg:p-8 flex flex-col justify-start items-start gap-4">
                            ...
                            <p className="text-neutral-200 text-sm font-light font-['Roboto'] tracking-tight">
                                Tingkatkan keterampilan Bahasa Inggris dan
                                Bahasa Jepang dengan karir yang lebih luas? ILP
                                Jababeka Cikarang adalah pilihan tepat untuk
                                belajar bahasa dengan metode interaktif dan
                                pengajar di tingkat mahir. Kami menyediakan
                                kursus bahasa untuk semua tingkatan, mulai dari
                                pemula hingga tingkat mahir.
                                <br />
                                Bergabunglah segera dengan kami kembangkan
                                karirmu dengan kemampuan bahasa yang lebih baik.
                                Daftar sekarang dan raih kesempatan emas untuk
                            ...
                            <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                                ...
                                <div className="w-full h-auto lg:h-[445px] bg-[#2c4cac] rounded-xl p-6 flex flex-col justify-start items-start gap-4">
                                    ...
                                    <p className="text-[#ecf0f8] text-sm font-semibold font-['Open Sans'] leading-tight">
                                        Yang bisa kamu dapat dengan mengikuti
                                        kelas ini :
                                    </p>
                                    ...
                                    <button className="w-full px-8 py-2 bg-white rounded-lg text-black text-sm font-normal font-['Roboto'] tracking-tight mt-4">
                                        Daftar sekarang
                                    </button>
                                </div>
